...
<head>
    ...
    <!-- Basic Styles -->
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo URL::to('assets');?>/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo URL::to('assets');?>/css/font-awesome.min.css">

    <!-- SmartAdmin Styles : Caution! DO NOT change the order -->
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo URL::to('assets');?>/css/smartadmin-production-plugins.min.css">
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo URL::to('assets');?>/css/smartadmin-production.min.css">
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo URL::to('assets');?>/css/smartadmin-skins.min.css">

    <!-- SmartAdmin RTL Support  -->
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo URL::to('assets');?>/css/smartadmin-rtl.min.css">
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo URL::to('assets');?>/css/demo.min.css">

    <!-- FAVICONS -->
    <link rel="shortcut icon" href="<?php echo URL::to('assets');?>/img/favicon/favicon.ico" type="image/x-icon">
    <link rel="icon" href="<?php echo URL::to('assets');?>/img/favicon/favicon.ico" type="image/x-icon">
    ...
    <link rel="apple-touch-icon" href="<?php echo URL::to('assets');?>/img/splash/sptouch-icon-iphone.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo URL::to('assets');?>/img/splash/touch-icon-ipad.png">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo URL::to('assets');?>/img/splash/touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo URL::to('assets');?>/img/splash/touch-icon-ipad-retina.png">
    ...
    <link rel="apple-touch-startup-image" href="<?php echo URL::to('assets');?>/img/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
    <link rel="apple-touch-startup-image" href="<?php echo URL::to('assets');?>/img/splash/ipad-portrait.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
    <link rel="apple-touch-startup-image" href="<?php echo URL::to('assets');?>/img/splash/iphone.png" media="screen and (max-device-width: 320px)">
...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <img src="<?php echo URL::to('assets');?>/img/logo.png" alt="SmartAdmin"> </span>
    ...
    <div class="pull-right">
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <img src="<?php echo URL::to('assets');?>/img/avatars/sunny.png" alt="John Doe" class="online" />
                </a>
        ...
        <ul class="header-dropdown-list hidden-xs">
            <li>
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo URL::to('assets');?>/img/blank.gif" class="flag flag-us" alt="United States"> <span> English (US) </span> <i class="fa fa-angle-down"></i> </a>
                <ul class="dropdown-menu pull-right">
                    <li class="active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div id="myCarousel" class="carousel fade profile-carousel">
                                            ...
                                            <div class="air air-bottom-right padding-10">
                                                <a href="javascript:void(0);" class="btn txt-color-white bg-color-teal btn-sm"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                            </div>
                                            @endcan
                                            <div class="air air-top-left padding-10">
                                                <h4 class="txt-color-white font-md">{{ $date }}</h4>
                                            </div>
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="item active">
                                                    <img class="col-lg-12" src="assets/img/demo/s1.jpg" alt="demo user" style="padding: 0">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="item">
                                                    <img class="col-lg-12" src="assets/img/demo/s2.jpg" alt="demo user" style="padding: 0">
                                                </div>
                                                <!-- Slide 3 -->
                                                <div class="item">
                                                    <img class="col-lg-12" src="assets/img/demo/m3.jpg" alt="demo user" style="padding: 0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <h1><small>Supervisor(s)</small></h1>
                                                <ul class="list-inline friends-list">
                                                    <li><img src="assets/img/avatars/354.jpg" alt="friend-1">
                                                    </li>
                                                </ul>

                                                <h1><small>Subordinates</small></h1>
                                                <ul class="list-inline friends-list">
...
<!-- Demo purpose only -->
<script src="<?php echo URL::to('assets');?>/js/demo.min.js"></script>
...
<script>
    $.SmartMessageBox({"title":"<i class='fa fa-sign-out txt-color-orangeDark'></i> Logout " +
    "<span class='txt-color-orangeDark'><strong>"+$("#show-shortcut").text()+"</strong></span> ?","content":a.data("logout-msg")||
    "You can improve your security further after logging out by closing this opened browser","buttons":"[No][Yes]"},
